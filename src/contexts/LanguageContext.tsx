...
const nl: Translations = {
  ...
  tarieven: {
    ...
    poaBody: "Elk traject is persoonlijk en wordt afgestemd op jouw lichaam, doelen en frequentie. Neem contact op voor een offerte op maat.",
...
const fr: Translations = {
  ...
  tarieven: {
    ...
    pricingNote:
      "(*) Tarifs hors TVA, non valables pour les ventes privées.",
...
const pt: Translations = {
  ...
  tarieven: {
    ...
    pricingNote: "(*) Preços sem IVA, não válido para vendas privadas.",
