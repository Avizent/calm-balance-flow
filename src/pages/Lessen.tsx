    ...
    <main className="pt-24">
      ...
      <section className="bg-sage">
        <div className="container-wide section-padding py-16 text-center">
          ...
          <Link to="/boeken#reservatie" className="inline-flex items-center gap-2 px-7 py-4 rounded-lg bg-card text-foreground font-sans font-medium text-sm hover:bg-card/90 transition-colors min-h-[48px]">
