    ...
    <main className="pt-24">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src={sessionImage} alt="Pilates sessie" className="w-full h-full object-cover object-center" width={501} height={640} loading="eager" decoding="async" {...({ fetchpriority: "high" } as any)} />
